...
export const getEventMediaStoragePath = (eventId: string, type: 'cover' | 'gallery', filename: string): string => {
  return `events/${eventId}/${type}/${filename}`;
};

export const getEventCoverStoragePath = (eventId: string, filename: string): string => {
  return getEventMediaStoragePath(eventId, 'cover', filename);
};

export const getEventGalleryStoragePath = (eventId: string, filename: string): string => {
  return getEventMediaStoragePath(eventId, 'gallery', filename);
};
